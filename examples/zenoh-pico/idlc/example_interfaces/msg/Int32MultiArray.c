/****************************************************************
  ...
  File name: /home/r22052/workspace/csdk/build/autel_msgs/src/example_interfaces/msg/Int32MultiArray.c
...
static const uint32_t example_interfaces_msg_Int32MultiArray_ops [] =
{
  /* Int32MultiArray */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (example_interfaces_msg_Int32MultiArray, layout), (3u << 16u) + 6u /* MultiArrayLayout */,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN, offsetof (example_interfaces_msg_Int32MultiArray, data),
  DDS_OP_RTS,
...
/* Type Information:
  [MINIMAL 8592efb35dd376c10dbb5dde8513] (#deps: 2)
   - [MINIMAL 3da6301ed97ae977de0d658704ac]
   - [MINIMAL adc347b48d2d7b27c1e10885b69b]
  [COMPLETE acf0e62a3aea4f772fed1fde58cc] (#deps: 2)
   - [COMPLETE 9ed2e139c0cd5b1237cf9dd72128]
   - [COMPLETE 55f59199cbdf96e8c58dac2956ed]
*/
#define TYPE_INFO_CDR_example_interfaces_msg_Int32MultiArray (unsigned char []){ \
  0xc0, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x40, 0x58, 0x00, 0x00, 0x00, 0x54, 0x00, 0x00, 0x00, \
  0x14, 0x00, 0x00, 0x00, 0xf1, 0x85, 0x92, 0xef, 0xb3, 0x5d, 0xd3, 0x76, 0xc1, 0x0d, 0xbb, 0x5d, \
  0xde, 0x85, 0x13, 0x00, 0x4c, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, \
  ...
  0x14, 0x00, 0x00, 0x00, 0xf2, 0xac, 0xf0, 0xe6, 0x2a, 0x3a, 0xea, 0x4f, 0x77, 0x2f, 0xed, 0x1f, \
  0xde, 0x58, 0xcc, 0x00, 0x8f, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, \
...
#define TYPE_INFO_CDR_SZ_example_interfaces_msg_Int32MultiArray 196u
#define TYPE_MAP_CDR_example_interfaces_msg_Int32MultiArray (unsigned char []){ \
  0x13, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0xf1, 0x85, 0x92, 0xef, 0xb3, 0x5d, 0xd3, 0x76, \
  0xc1, 0x0d, 0xbb, 0x5d, 0xde, 0x85, 0x13, 0x00, 0x48, 0x00, 0x00, 0x00, 0xf1, 0x51, 0x01, 0x00, \
  ...
  0xf2, 0xac, 0xf0, 0xe6, 0x2a, 0x3a, 0xea, 0x4f, 0x77, 0x2f, 0xed, 0x1f, 0xde, 0x58, 0xcc, 0x00, \
  ...
  0x33, 0x32, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x41, 0x72, 0x72, 0x61, 0x79, 0x00, 0x00, 0x00, 0x00, \
  ...
  0x01, 0x00, 0x00, 0x04, 0x05, 0x00, 0x00, 0x00, 0x64, 0x61, 0x74, 0x61, 0x00, 0x00, 0x00, 0xf2, \
  ...
  0x03, 0x00, 0x00, 0x00, 0xf2, 0xac, 0xf0, 0xe6, 0x2a, 0x3a, 0xea, 0x4f, 0x77, 0x2f, 0xed, 0x1f, \
  0xde, 0x58, 0xcc, 0xf1, 0x85, 0x92, 0xef, 0xb3, 0x5d, 0xd3, 0x76, 0xc1, 0x0d, 0xbb, 0x5d, 0xde, \
  0x85, 0x13, 0xf2, 0x9e, 0xd2, 0xe1, 0x39, 0xc0, 0xcd, 0x5b, 0x12, 0x37, 0xcf, 0x9d, 0xd7, 0x21, \
...
#define TYPE_MAP_CDR_SZ_example_interfaces_msg_Int32MultiArray 878u
const dds_topic_descriptor_t example_interfaces_msg_Int32MultiArray_desc =
{
  .m_size = sizeof (example_interfaces_msg_Int32MultiArray),
  .m_align = dds_alignof (example_interfaces_msg_Int32MultiArray),
  .m_flagset = DDS_TOPIC_XTYPES_METADATA,
  .m_nkeys = 0u,
  .m_typename = "example_interfaces::msg::Int32MultiArray",
  .m_keys = NULL,
  .m_nops = 10,
  .m_ops = example_interfaces_msg_Int32MultiArray_ops,
  .m_meta = "",
  .type_information = { .data = TYPE_INFO_CDR_example_interfaces_msg_Int32MultiArray, .sz = TYPE_INFO_CDR_SZ_example_interfaces_msg_Int32MultiArray },
  .type_mapping = { .data = TYPE_MAP_CDR_example_interfaces_msg_Int32MultiArray, .sz = TYPE_MAP_CDR_SZ_example_interfaces_msg_Int32MultiArray }
};
