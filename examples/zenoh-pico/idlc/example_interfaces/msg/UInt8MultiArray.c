/****************************************************************
  ...
  File name: /home/r22052/workspace/csdk/build/autel_msgs/src/example_interfaces/msg/UInt8MultiArray.c
...
static const uint32_t example_interfaces_msg_UInt8MultiArray_ops [] =
{
  /* UInt8MultiArray */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (example_interfaces_msg_UInt8MultiArray, layout), (3u << 16u) + 6u /* MultiArrayLayout */,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_1BY, offsetof (example_interfaces_msg_UInt8MultiArray, data),
  DDS_OP_RTS,
...
/* Type Information:
  ...
  [COMPLETE 2294ea690417c9eaeb4483285c86] (#deps: 2)
   - [COMPLETE 9ed2e139c0cd5b1237cf9dd72128]
   - [COMPLETE 55f59199cbdf96e8c58dac2956ed]
*/
#define TYPE_INFO_CDR_example_interfaces_msg_UInt8MultiArray (unsigned char []){ \
  ...
  0x14, 0x00, 0x00, 0x00, 0xf2, 0x22, 0x94, 0xea, 0x69, 0x04, 0x17, 0xc9, 0xea, 0xeb, 0x44, 0x83, \
  0x28, 0x5c, 0x86, 0x00, 0x8f, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, \
...
#define TYPE_INFO_CDR_SZ_example_interfaces_msg_UInt8MultiArray 196u
#define TYPE_MAP_CDR_example_interfaces_msg_UInt8MultiArray (unsigned char []){ \
  ...
  0xf2, 0x22, 0x94, 0xea, 0x69, 0x04, 0x17, 0xc9, 0xea, 0xeb, 0x44, 0x83, 0x28, 0x5c, 0x86, 0x00, \
  ...
  0x74, 0x38, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x41, 0x72, 0x72, 0x61, 0x79, 0x00, 0x00, 0x00, 0x00, \
  ...
  0x03, 0x00, 0x00, 0x00, 0xf2, 0x22, 0x94, 0xea, 0x69, 0x04, 0x17, 0xc9, 0xea, 0xeb, 0x44, 0x83, \
  0x28, 0x5c, 0x86, 0xf1, 0xe6, 0x9e, 0xfb, 0xe5, 0x02, 0x0e, 0xb3, 0x4f, 0x30, 0x6a, 0x36, 0x32, \
  0x04, 0x89, 0xf2, 0x9e, 0xd2, 0xe1, 0x39, 0xc0, 0xcd, 0x5b, 0x12, 0x37, 0xcf, 0x9d, 0xd7, 0x21, \
...
#define TYPE_MAP_CDR_SZ_example_interfaces_msg_UInt8MultiArray 878u
const dds_topic_descriptor_t example_interfaces_msg_UInt8MultiArray_desc =
{
  .m_size = sizeof (example_interfaces_msg_UInt8MultiArray),
  .m_align = dds_alignof (example_interfaces_msg_UInt8MultiArray),
  .m_flagset = DDS_TOPIC_XTYPES_METADATA,
  .m_nkeys = 0u,
  .m_typename = "example_interfaces::msg::UInt8MultiArray",
  .m_keys = NULL,
  .m_nops = 10,
  .m_ops = example_interfaces_msg_UInt8MultiArray_ops,
  .m_meta = "",
  .type_information = { .data = TYPE_INFO_CDR_example_interfaces_msg_UInt8MultiArray, .sz = TYPE_INFO_CDR_SZ_example_interfaces_msg_UInt8MultiArray },
  .type_mapping = { .data = TYPE_MAP_CDR_example_interfaces_msg_UInt8MultiArray, .sz = TYPE_MAP_CDR_SZ_example_interfaces_msg_UInt8MultiArray }
};
